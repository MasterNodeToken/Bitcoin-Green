![Absolute-Logo](https://i.imgur.com/wKSh1Hk.png)
# Absolute Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Absolute Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/FhtgzY8)
***
## Requirements
1) **1,000 Absolute coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Absolute/master/abs_install.sh`
***
...
***Step 1***
* Download and install the Absolute wallet [here](https://github.com/absolute-community/absolute/releases/tag/12.2.1)
***

***Step 2***
* Send EXACLY 1,000 ABS to a receive address within your wallet.
***
